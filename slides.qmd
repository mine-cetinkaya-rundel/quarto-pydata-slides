---
title: "From Jupyter Notebooks to websites with Quarto"
author: "Mine Çetinkaya Rundel"
institute: "Duke University + Posit"
footer: "🔗 [bit.ly/quarto-pydata](https://bit.ly/quarto-pydata)"
format:
  revealjs:
    transition: fade
    slide-number: true
...
-   Quarto 1.4.464: <https://quarto.org/docs/download/prerelease.html>
...
**4. Exercises:** Go to [`bit.ly/quarto-pydata-website`](https://bit.ly/quarto-pydata-website), click on "Use this template" then "Create a new repository". Once your repository is created, clone it locally and navigate to the repo folder.
:::
...
::: aside
[For more info and reporting a code of conduct incident](https://pydata.org/code-of-conduct/)
:::
...
::: demo
-   Running individual cells and `quarto render`ing entire document
...
```{=html}
<iframe src="https://en.wikipedia.org/wiki/Quarto" title = "Quarto on Wikipedia" frameborder="1" height="450" width="900"></iframe>
```
::: aside
